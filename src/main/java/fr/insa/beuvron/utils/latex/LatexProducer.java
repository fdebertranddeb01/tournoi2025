...
public interface LatexProducer {
  ...
  /**
   * return the latex representation of this. As a side effect, add all required includes in the
   * collect parameter. These includes will be taken care of in a {@link TopLevelLatex} or may be
   * simply ignored in a embeded context
   *
   * @param out
   * @param collect
   */
