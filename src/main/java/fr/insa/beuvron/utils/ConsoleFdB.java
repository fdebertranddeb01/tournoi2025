...
public class ConsoleFdB implements java.io.Serializable {
  ...
  /**
   * cette methode affiche un message sur le flux de sortie standard (System.out), et attend que
   * l'utilisateur entre une ligne de texte qui sera convertie en entier sur le flux d'entrée
   * standard (System.in) cette methode redemande tant qu'un entier correct n'a pas été entré elle
  ...
  /**
   * cette methode affiche un message sur le flux de sortie standard (System.out), et attend que
   * l'utilisateur entre une ligne de texte qui sera convertie en entier long sur le flux d'entrée
   * standard (System.in) cette methode redemande tant qu'un entier correct n'a pas été entré elle
   * termine le programme en cas d'exeption d'entré/sortie
   *
   * @param s message à l'utilisateur
  ...
  /**
   * cette methode affiche un message sur le flux de sortie standard (System.out), et attend que
   * l'utilisateur entre O pour oui ou N pour non cette methode redemande tant qu'un entier correct
   * n'a pas été entré elle termine le programme en cas d'exeption d'entré/sortie
   *
   * @param s message à l'utilisateur
   * @return un entier tapé par l'utilisateur
   * @see java.lang.System#in
  ...
  /**
   * cette methode affiche un message sur le flux de sortie standard (System.out), et attend que
   * l'utilisateur entre une ligne de texte qui sera convertie en flottant double précision sur le
   * flux d'entrée standard (System.in) cette methode redemande tant qu'un flottant correct n'a pas
  ...
  /**
   * cette methode affiche un message sur le flux de sortie standard (System.out), et attend que
   * l'utilisateur entre une ligne de texte sur le flux d'entrée standard (System.in) dont le
   * premier caractère sera retourné cette methode redemande tant qu'un caractère n'a pas été entré
  ...
  /**
   * cette methode affiche un message sur le flux de sortie standard (System.out), et attend que
   * l'utilisateur entre une ligne de texte sur le flux d'entrée standard (System.in) qui sera
   * retournée sous forme de String (sans le caractère de fin de ligne) cette methode termine le
  ...
  /**
   * cette methode affiche un message sur le flux de sortie standard (System.out), et attend que
   * l'utilisateur entre plusieurs lignes de texte sur le flux d'entrée standard (System.in) qui
   * sera retournée sous forme de String. La saisie s'arrete quand l'utilisateur tape "fin" sur une
   * ligne. cette methode termine le programme en cas d'exeption d'entré/sortie
   *
   * @param s message à l'utilisateur
   * @return une chaîne tapées par l'utilisateur
   * @see java.lang.System#in
