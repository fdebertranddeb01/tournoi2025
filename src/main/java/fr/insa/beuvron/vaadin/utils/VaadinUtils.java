...
public class VaadinUtils {
  ...
  public static void encadre(
      Component c, CSSUtils.BorderStyle style, int largeurEnPixel, Color couleur) {
  ...
  public static void colorPaddingMargin(
      Component c,
      Color paddingColor,
      int paddingSizeInPixel,
      Color marginColor,
    ...
    c.getStyle()
        .set(
            "box-shadow",
            "0px 0px 0px " + marginSizeInPixel + "px " + CSSUtils.toCSSColor(marginColor));
  }
}
