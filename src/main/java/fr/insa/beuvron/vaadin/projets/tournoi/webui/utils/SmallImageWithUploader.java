 ...
 */
public class SmallImageWithUploader extends CustomField<SmallImage> {
  ...
  @Override
  protected SmallImage generateModelValue() {
    return this.curImage;
  }

  @Override
  protected void setPresentationValue(SmallImage newPresentationValue) {
    this.setCurImage(newPresentationValue);
  }
