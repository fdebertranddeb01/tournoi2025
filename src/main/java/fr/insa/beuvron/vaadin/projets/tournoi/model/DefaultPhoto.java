...
public class DefaultPhoto {
    ...
    public static final String PETIT_SMILEY_CONTENT_BASE64_PNG = "iVBORw0KGgoAAAANSUhEUgAAADIAAABLCAYAAAAyEtS4AAAAAXNSR0IB2cksfwAAAARnQU1BAACxjwv8"
            +
    ...
    public static byte[] getPhotoBytes(String base64) {
